...
const Home: NextPage = () => {
  ...
  return (
    <div className={styles.container}>
      ...
      <Head>
        <meta property="og:title" content={'Kosmic DAO Raffles'} key="ogtitle" />
        <meta property="og:description" content={'Create & Participate in raffles on Solana, brought to you by Kosmic DAO'} key="ogdesc" />
      ...
      <div className={styles.disclaimer}>
        <h3>Disclaimer</h3>
        <p>
          Kosmic DAO is providing a service to host raffles, we do not
